# Evaluating the AM-FM model at a time instant of type Float64.
julia> t₀ = 2.0; z(t₀)
-0.14301691708182013 - 0.40883650170394287im

# Evaluating the AM-FM model over a step range of time instants.
...
# Evaluating the AM-FM model at time instants of type Vector{Float64}.
